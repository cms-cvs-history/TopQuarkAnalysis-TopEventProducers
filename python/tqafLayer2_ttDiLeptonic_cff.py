...
tqafLayer2_ttDileptonic_FullLepFilter = cms.Sequence(makeGenEvt*ttFullLeptonicFilter*solutions)
...
tqafLayer2_ttDileptonic_FullHadFilter = cms.Sequence(makeGenEvt*ttFullHadronicFilter*solutions)
