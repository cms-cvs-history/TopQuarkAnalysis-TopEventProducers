...
## trivial hypothesis                                                        
from TopQuarkAnalysis.TopJetCombination.TtSemiLepHypTrivial_cff import *
...
makeTtSemiLepHypotheses  = cms.Sequence(makeHypothesis_genMatch)  # makeHypothesis_trivial
                                                                  # makeHypothesis_geom
